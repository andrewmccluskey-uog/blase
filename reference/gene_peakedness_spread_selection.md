...
spread regions of pseudotime, and then selecting genes with the highest
peakedness ratio with a peak inside that region of pseudotime. The
number of regions and genes per region can be tuned.
...
- sce:
  ...
  to obtain pseudotime values from
...
- n_gene_bins:
  ...
  Integer. Number of gene bins to create over pseudotime. We recommend
  around 1-2x the number of pseudotime bins you want to use.
