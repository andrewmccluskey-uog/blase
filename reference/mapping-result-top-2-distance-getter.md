...
Get the difference in correlation between the top 2 most correlated bins
for a BLASE Mapping Results object.
...
Decimal. The difference in correlation between the top 2 most correlated
