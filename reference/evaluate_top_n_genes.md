...
Shows plots over bins of expression of the top n genes. This is designed
to help identify if you have selected genes that vary over the
pseudotime you have chosen bins to exist over. Uses the normcounts of
the SCE.
...
- blase_data:
  ...
  to get bins and expression from.
...
- plot_columns:
  ...
  Integer. The number of columns to plot the grid with. Best as a
...
plot showing the normalised expression of the top genes over pseudotime
bins.
