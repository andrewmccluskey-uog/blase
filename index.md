...
for users of BLASE, we provide a function
[`get_top_n_genes()`](https://andrewmccluskey-uog.github.io/blase/reference/get_top_n_genes.md)
which enables simple selection of a certain number of genes from an
...
BlaseData object, or when using the
[`assign_pseudotime_bins()`](https://andrewmccluskey-uog.github.io/blase/reference/assign_pseudotime_bins.md)
function to add these to the metadata of SingleCellExperiment or Seurat
object. Because the BLASE algorithm relies heavily on these bins, it is
