...
This article, which is not run for this website, shows how we prepare the Malaria Cell Atlas Plasmodium Falciparum ([Howick et al. 2019](https://doi.org/10.1126/science.aaw2619) 10x single cell data. It can be used to generate it from scratch, but we provide the processed object with BLASE.
...
article_dir = path(root_dir, "Generate_MCA_PF_Object")
...
usethis::use_data(processed_MCA_PF_SCE, overwrite = TRUE)
```
