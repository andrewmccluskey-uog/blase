...
plotUMAP(annotated_sce, colour_by = "pseudotime_bin")
plotUMAP(annotated_sce, colour_by = "BLASE_Annotation")
plotUMAP(annotated_sce, colour_by = "BLASE_Annotation_Best_Mapping_Correlation")
...
# plotUMAP(annotated_sce, colour_by="BLASE_annotation_transfer_hd")
```
