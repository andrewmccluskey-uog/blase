...
```{r}
cibersort_results_path = system.file("extdata", "CIBERSORTX_Job6_Results.csv", package = "blase")
cibersort_results = read.table(cibersort_results_path, sep = ',', header=TRUE)
