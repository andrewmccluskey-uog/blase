...
gridExtra::grid.arrange(
  blase::plot_bin_population(sc_sce, 1, group_by_slot="label"),
  blase::plot_bin_population(bulk_sce, 1, group_by_slot="label"),
  blase::plot_mapping_result_corr(mapping_results[[1]]),
  blase::plot_mapping_result_corr(mapping_results[[2]]),
  blase::plot_bin_population(sc_sce, 2, group_by_slot="label"),
  blase::plot_bin_population(bulk_sce, 2, group_by_slot="label"),
  blase::plot_mapping_result_corr(mapping_results[[3]]),
  blase::plot_mapping_result_corr(mapping_results[[4]]),
  blase::plot_bin_population(sc_sce, 3, group_by_slot="label"),
  blase::plot_bin_population(bulk_sce, 3, group_by_slot="label"),
  blase::plot_mapping_result_corr(mapping_results[[5]]),
  blase::plot_mapping_result_corr(mapping_results[[6]]),
  blase::plot_bin_population(sc_sce, 4, group_by_slot="label"),
  blase::plot_bin_population(bulk_sce, 4, group_by_slot="label"),
  blase::plot_mapping_result_corr(mapping_results[[7]]),
  blase::plot_mapping_result_corr(mapping_results[[8]]),
  blase::plot_bin_population(sc_sce, 5, group_by_slot="label"),
  blase::plot_bin_population(bulk_sce, 5, group_by_slot="label"),
  blase::plot_mapping_result_corr(mapping_results[[9]]),
  blase::plot_mapping_result_corr(mapping_results[[10]]),
  ncol=4
)
