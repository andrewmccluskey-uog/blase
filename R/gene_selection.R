...
#' @description
#' Generates a plot showing the progression of genes and cells through pseudotime.
#' Plots are of log normalised expression values.
#'
...
#' @param genes The genes to generate matrix for. When an empty list, all genes are used. Defaults to c().
...
#' @param n_groups The number of divisions of pseudotime to use when force_spread_selection=TRUE.
#' Has no effect when force_spread_selection=FALSE. Defaults to 40.
#' @param top_n_per_group The number of genes per group to use when force_spread_selection=TRUE.
#' Has no effect when force_spread_selection=FALSE. Defaults to 1.
#' @param method The wave parameter to use for ordering genes. 'r2' maximises explained variance.
#' 'amplitdue' maximises wave amplitude. 'power' maximises the power parameter from Bozdech et al.
#' 2003 (https://doi.org/10.1371/journal.pbio.0000005, in short, the strength of signal near
...
#' amplitude, and r2 (explained variance) of the pattern in the gene. This function
#' uses the normalised counts.
#'
